...
%
In this paper, we present a novel network named hierarchical fused fully convolution network(HF-FCN) which fuses the information within the group and between groups.
%
Additionally, The experiments on several available remote sensing image datasets show that our method achieves state-of-the-art performance. 
%
It is also a attempt for further application that combining the building detection via deep learning with available Digital Surface Model (DSM) map to 3D modeling.
%
